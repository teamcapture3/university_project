...
<title>Welcome To Online Mock Test!</title>
...
<div class="col-lg-6">
<span class="logo">We value your suggesions.</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<h2 align="center" style="font-family:'typo'; color:#000066">Got a problem? Tell us before others.</h2>
<div style="font-size:14px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
Prefer to write us a detailed mail? Write to us on:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:teamcapture3@gmail.com" style="color:#000000">teamcapture3@gmail.com</a><br /><br />
</div><div class="col-md-1"></div></div>
<p>Or you can keep it simple (we do love to get smarter everyday!):</p>
...
<a href="https://teamcapture3.github.io/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/ban.jpg" width=100 height=100 alt="Team Capture" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://github.com/teamcapture3" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Github">Team Capture</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Team Members :</h4>
		<h4 style="font-family:'typo' ">Ninad Patil</h4>
		<h4 style="font-family:'typo' ">Sarath Shankaranarayanan</h4></div></div>
		</p>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
